...
VALUES
('NV01','Nguyen Van A','Nam','2003-07-02','To dan pho Hoa Tien, Phuong Cam Nghia, TP Cam Ranh, Tinh Khanh Hoa','2020-12-12','MB:32758740','Bang Dai Hoc',10000000,NULL,NULL),
('NV02','Nguyen Thanh B','Nam','2003-10-13','62 Vo Van Tan, Phuong 6, Quan 3, TP Ho Chi Minh','2020-12-25','VCB:028374072','Chung chi IELTS 7.0',NULL,30000,'NV01'),
('NV03','Tran Trung C','Nam','2002-11-12','27 Tran Quoc Thao, Phuong 6, Quan 3, TP Ho Chi Minh','2020-12-25','TCB:02837013','Bang Dai Hoc',NULL,29000,'NV01'),
('NV04','Le Van D','Nam','2001-01-01','7 Nguyen Chi Thanh, TP Da Lat, Tinh Lam Dong','2020-12-25','MB:02834031','Bang Dai Hoc',8000000,NULL,'NV01'),
('NV05','Nguyen Thanh E','Nam','2004-10-10','121 Xo Viet Nghe Tinh, Phuong 17, Quan Binh Thanh, TP Ho Chi Minh','2020-12-25','ACB:028740113','Bang TOEIC 650',9500000,NULL,'NV01'),
('NV06','Nguyen Thi F','Nu','2005-11-11','64 Nguyen Thoi Trung, Phuong 6, Quan 5, TP Ho Chi Minh','2020-12-25','VCB:01387049',NULL,NULL,27000,'NV01'),
('NV07','Cao Hoang G','Nu','2003-04-21','To dan pho Hoa Binh, Phuong Cam Phuc Bac, TP Cam Ranh, Tinh Khanh Hoa','2020-12-25','MB:013801029','Bang Ke Toan',10000000,NULL,'NV01')
...
VALUES
('NV01','nva113@gmail.com','0918293820'),
('NV02','ntb111@gmail.com','0928938293'),
('NV03','ttc121@gmail.com','0113839238'),
('NV04','lvd123@gmail.com','0192837291'),
('NV05','nte222@gmail.com','0912839283'),
('NV06','ntf001@gmail.com','0567989283'),
('NV07','chg122@gmail.com','0193198498')
...
VALUES
('Sup Hai San',1,'NV01','Nguyen Van A'),
('Gio Heo muoi chien',1,'NV02','Nguyen Thanh B'),
('Loi vai bo my nuong',1,'NV02','Nguyen Thanh B'),
('Xoi bo cau',1,'NV02','Nguyen Thanh B'),
('Salad ca ngu',1,'NV01','Nguyen Van A'),
('Khoai tay rocket',1,'NV01','Nguyen Van A'),
('Ca hoi ap chao',1,'NV02','Nguyen Thanh B')
